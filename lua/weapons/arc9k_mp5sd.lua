...
SWEP.ViewModel = "models/weapons/m9k_smalls/arc9k_mp5sd.mdl"
...
SWEP.ShootSound = "^m9k_arc9/mp5sd/fire_sup.wav" 
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "m9k_arc9/mp5sd/magout.wav", t = 0.18},
            {s = "rz_foley/pouches/magpouch_pull_small.wav", t = 0.88},
            {s = "m9k_arc9/mp5sd/magin.wav", t = 1.39},
            {s = "rz_foley/grabs/grab_polymer.wav", t = 1.95},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        EventTable = {
            {s = "m9k_arc9/mp5sd/magout.wav", t = 0.18},
            {s = "m9k_arc9/mp5sd/back.wav", t = 0.88},
            {s = "m9k_arc9/mp5sd/lock.wav", t = 1.05},
            {s = "rz_foley/pouches/magpouch_pull_small.wav", t = 1.45},
            {s = "m9k_arc9/mp5sd/magin.wav", t = 1.95},
            {s = "m9k_arc9/mp5sd/slap.wav", t = 2.5},
            {s = "rz_foley/grabs/grab_polymer.wav", t = 2.85},
        }
    },
}