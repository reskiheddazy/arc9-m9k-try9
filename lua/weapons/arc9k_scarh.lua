...
SWEP.ViewModel = "models/weapons/m9k_rifles/arc9k_scarh.mdl"
...
SWEP.RangeMax = 4750 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.ShootSound = "^m9k_arc9/scarh/fire_fp.wav" 
SWEP.DistantShootSound = "^m9k_arc9/scarh/fire_sup.wav"
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "rz_foley/grabs/grab_polymer.wav", t = 0},
            {s = "rz_foley/pouches/magpouch_pull_rifle.wav", t = 0.05},
            {s = cloths , t = 0.05},
            {s ="m9k_arc9/scarh/magout.wav", t = 0.36},
            {s = "m9k_arc9/scarh/maghit.wav", t = 0.95},
            {s = "m9k_arc9/scarh/magin.wav", t = 1.2},
            {s = "rz_foley/pouches/magpouchin.wav", t = 1.5},
            {s = "rz_foley/grabs/grab_polymer.wav", t = 2},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        EventTable = {
            {s = "rz_foley/grabs/grab_polymer.wav", t = 0},
            {s = "m9k_arc9/scarh/magout.wav", t = 0.01},
            {s = "rz_foley/pouches/magpouch_pull_rifle.wav", t = 0.95},
            {s = "m9k_arc9/scarh/maghit.wav", t = 1.52},
            {s = "m9k_arc9/scarh/magin.wav", t = 1.62},
            {s = "m9k_arc9/scarh/boltcatchpress.wav", t = 1.95},
            {s = "rz_foley/grabs/grab_polymer.wav", t = 2.40},
        }
    },
}