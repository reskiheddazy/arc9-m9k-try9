...
SWEP.ViewModel = "models/weapons/m9k_smalls/arc9k_mp9.mdl"
...
SWEP.ShootSound = "^m9k_arc9/mp9/fire_fp.wav" 
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "rz_foley/pouches/magpouch_pull_small.wav", t = 0.08},
            {s = "m9k_arc9/mp9/magout.wav", t = 0.42},
            {s = "m9k_arc9/mp9/maghit.wav", t = 0.92},
            {s = "m9k_arc9/mp9/magin.wav", t = 0.98},
            {s = "rz_foley/pouches/magpouchin.wav", t = 1.25},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        EventTable = {
            {s = "m9k_arc9/mp9/magout.wav", t = 0.15},
            {s = "rz_foley/pouches/magpouch_pull_small.wav", t = 0.75},
            {s = "m9k_arc9/mp9/maghit.wav", t = 1.52},
            {s = "m9k_arc9/mp9/magin.wav", t = 1.56},
            {s = "m9k_arc9/mp9/release.wav", t = 1.88},
        }
    },
}