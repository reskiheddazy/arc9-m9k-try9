...
SWEP.ViewModel = "models/weapons/m9k_rifles/arc9k_amd65.mdl"
...
SWEP.ShootSound = "^m9k_arc9/ak47/fire_fp.wav" 
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "m9k_arc9/amd65/magout.wav", t = 0.45},
            {s = "m9k_arc9/amd65/maghit.wav", t = 0.95},
            {s = "m9k_arc9/ak47/magin.wav", t = 1.1},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        EventTable = {
            {s = "m9k_arc9/amd65/magout.wav", t = 0.45},
            {s = "m9k_arc9/amd65/maghit.wav", t = 1.05},
            {s = "m9k_arc9/ak47/magin.wav", t = 1.15},
            {s = "m9k_arc9/ak47/back.wav", t = 1.80},
            {s = "m9k_arc9/ak47/fwd.wav", t = 1.9},
        }
    },
}