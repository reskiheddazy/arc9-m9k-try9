...
SWEP.ViewModel = "models/weapons/m9k_smalls/arc9k_sten.mdl"
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "m9k_arc9/sten/magout.wav", t = 0.1},
            {s = "rz_foley/pouches/magpouch_pull_small.wav", t = 0.7},
            {s = "m9k_arc9/sten/maghit.wav", t = 1.2},
            {s = "m9k_arc9/sten/magin.wav", t = 1.24},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        EventTable = {
            {s = "m9k_arc9/sten/boltback.wav", t = 0.13},
            {s = "m9k_arc9/sten/magout.wav", t = 0.68},
            {s = "rz_foley/pouches/magpouch_pull_small.wav", t = 1.4},
            {s = "m9k_arc9/sten/maghit.wav", t = 1.9},
            {s = "m9k_arc9/sten/magin.wav", t = 1.95},
            {s = "m9k_arc9/sten/boltrel.wav", t = 2.3},
        }
    },
}