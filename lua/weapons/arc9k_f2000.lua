...
SWEP.ViewModel = "models/weapons/m9k_rifles/arc9k_f2000.mdl"
...
SWEP.ShootSound = "^m9k_arc9/f2000/fire_fp.wav" 
SWEP.DistantShootSound = "^m9k_arc9/f2000/fire_sup.wav"
...
SWEP.Attachments = {
    {
        PrintName = "Optic",
        Category = "m9k_optic",
        Integral = "m9k_f2000rt", -- pre-installed and non-removable
        Bone = "weapon",
        Pos = Vector(3.029, -5.302, -14.367),
        Ang = Angle(90, 0, -90),
    },
}
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            {s = "m9k_arc9/f2000/boltfwd.wav", t = 2.22},
        }
    },
}