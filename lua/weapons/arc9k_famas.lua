...
SWEP.ViewModel = "models/weapons/m9k_rifles/arc9k_famas.mdl"
...
SWEP.ShootSound = "^m9k_arc9/famas/fire_fp.wav" 
...
SWEP.IronSights = {
    Pos = Vector(-3.901, -5, 1),
    Ang = Angle(0.514,-0.076, 0),
    Magnification = 1,
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "m9k_arc9/famas/magout.wav", t = 0.23},
            {s = "rz_foley/pouches/magpouch_pull_rifle.wav", t = 0.8},
            {s = "m9k_arc9/famas/maghit.wav", t = 1.45},
            {s = "m9k_arc9/famas/magin.wav", t = 1.48},
            {s = "rz_foley/grabs/grab_metal.wav", t = 2},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        EventTable = {
            ...
            {s = "m9k_arc9/famas/maghit.wav", t = 1.45},
            {s = "m9k_arc9/famas/magin.wav", t = 1.48},
            {s = "m9k_arc9/famas/back.wav", t = 1.95},
            {s = "m9k_arc9/famas/fwd.wav", t = 2.15},
