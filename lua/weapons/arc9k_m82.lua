...
SWEP.ViewModel = "models/weapons/m9k_heavy/arc9k_m82.mdl"
...
SWEP.RangeMax = 4550 -- range battle rifles
...
SWEP.ShootSound = "^m9k_arc9/m82/fire_fp.wav" 


SWEP.MuzzleParticle = "muzzleflash_m82" -- Used for some muzzle effects.

SWEP.ShellPitch = 45 -- for shell sounds
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "m9k_arc9/m82/magrel.wav", t = 0.2},
            {s = "m9k_arc9/intervention/magout.wav", t = 0.45},
            {s = "m9k_arc9/intervention/maghit.wav", t = 1.75},
            {s = "m9k_arc9/intervention/magin.wav", t = 1.78},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        EventTable = {
            ...
            {s = "m9k_arc9/intervention/maghit.wav", t = 1.75},
            {s = "m9k_arc9/intervention/magin.wav", t = 1.78},
            {s = "m9k_arc9/m82/back.wav", t = 2.55},
            {s = "m9k_arc9/m82/fwd.wav", t = 2.79},
        }
    },
}